...
do_GE     = 0;
do_pijoan = 1;   % If 1, load shocks from Pijoan-Mas files; otherwise discretize AR(1)
n_a       = 600; % Number of grid points for assets
n_d       = 100; % Number of grid points for labor supply
